...
const Head = () => {
    ...
    return (
        <div className="grid grid-flow-col items-center h-14 bg-[#0f0f0f]">
            ...
            <div className='col-span-10 mr-10 flex justify-center border-none'>
                <input className='w-1/3 py-[7px] px-4 border-[#303030] rounded-l-full text-white bg-[#0f0f0f] border-[1px] focus:border-[#2d5faf] focus:outline-none' placeholder='Search' />
